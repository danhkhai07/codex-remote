...
writeJson(release + '/seal.json', { version: 1, app: APP, status: 'prepared-not-armed', at: new Date().toISOString(), files: tree(release) })
console.log(JSON.stringify({ release, app: APP, status: 'prepared-not-armed', sealSha256: fileHash(release + '/seal.json') }))
